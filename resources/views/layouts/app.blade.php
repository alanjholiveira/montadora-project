                ...
                <a class="navbar-brand d-flex align-items-center justify-content-center" href="{{ url('/') }}">
                    <div class="sidebar-brand-icon rotate-n-15">
                        <span style="color: orange;">
                            <i class="fab fa-laravel fa-w-16 fa-3x shadow-sm"></i>
                        </span>
                    </div>
                    ...
                    <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                        ...
                        <li class="nav-item dropdown show">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                <a class="dropdown-item" href="{{route('categories.index')}}">Categoria</a>
                                <a class="dropdown-item" href="{{route('automobiles.index')}}">Veiculos</a>
                            </div>
                        </li>
                        <li class="nav-item">
